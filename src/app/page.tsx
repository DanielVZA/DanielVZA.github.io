...
export default function Home() {
    return (
        <div>
            <header>
                <nav className="navbar navbar-expand-lg navbar-dark bg-primary fondo-banner" style={{width: '100%'}}>
                    <button className="navbar-brand banger-25 links" onClick={() => console.log("cargarIndex")}>COMIC
                        STORE</button>
                        ...
                        <ul className="navbar-nav ml-auto banger">
                            ...
                            <li className="nav-item">
                                <button className="nav-link text-white links" id="superheroes"
                                   onClick={() => console.log("cargarSuperHero")}>SUPER HEROES</button>
                            </li>
                        </ul>
                ...
                <div id="index">
                    <div className="container-fluid">
                        ...
                        <div className="row p-4 mt-3 mb-3" style={{backgroundColor: '#000'}}>
                            ...
                            <div className="col col-xl-12 col-12 text-center">
                                <img src="imges/kickass.jpg" className="img-fluid" />
                            </div>
                        </div>
                        <div className="row m-2">
                            <ComicBook minId={4}/>
